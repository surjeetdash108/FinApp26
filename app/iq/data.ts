// ============================================================
// STOCKWISE — SHARED TYPES
// ============================================================
// This module used to also export hardcoded mock data alongside these
// types. The mock arrays/objects have been removed — every screen now
// renders only what the backend APIs return. These interfaces remain
// because they're the shapes screens still use to type live/merged data.
...
// ---- Screener presets ----
// Pure UI configuration (named filter shortcuts), not market data — stays static.
